...
autoencoder.save(r'C:\ColorizerNew.h5')
...
# Save model weights
autoencoder.save_weights(r'C:\autoencoder_weightsvNew.h5')
encoder.save_weights(r'C:\encoder_weightsvNew.h5')

# In[12]: Test Model

# Test images to evaluate the model
img1_color = []
img1 = img_to_array(load_img(r'C:\Test Images\960x0.jpg'))
